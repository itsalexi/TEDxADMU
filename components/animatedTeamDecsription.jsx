  ...
  return (
    ...
    >
      ...
      <Link href="/event-details">
        <span className="inline-block mt-12 bg-[#eb0028] hover:bg-red-700 text-white text-base sm:text-lg md:text-xl px-5 sm:px-6 py-2 sm:py-3 font-medium cursor-pointer transition duration-300 ease-in-out transform hover:scale-105">
          View Topics
        </span>
      </Link>
    </div>
